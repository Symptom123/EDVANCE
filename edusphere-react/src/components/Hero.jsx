  ...
  <div className="hero-visual-container">
    ...
    <div className="hero-abstract-curves" aria-hidden="true">
      <svg width="460" height="460" viewBox="0 0 460 460" fill="none">
        <circle cx="230" cy="230" r="210" stroke="#1E5FD9" strokeWidth="1.5" strokeDasharray="6 6" opacity="0.25" />
        <circle cx="230" cy="230" r="175" stroke="#0F1E33" strokeWidth="1" opacity="0.12" />
    ...
    <div className="hero-circle-frame">
      <div className="hero-circle-inner">
        ...
        <svg viewBox="0 0 400 400" fill="none" className="hero-center-graphic">
          ...
          <rect x="70" y="80" width="260" height="34" rx="16" fill="#0F1E33" />
          <rect x="70" y="100" width="260" height="14" fill="#0F1E33" />
          ...
          <rect x="88" y="128" width="130" height="10" rx="5" fill="#0F1E33" opacity="0.85" />
          <rect x="88" y="146" width="90" height="7" rx="3.5" fill="#1E5FD9" opacity="0.6" />

          {/* Mini Table Rows */}
          <rect x="88" y="165" width="224" height="24" rx="6" fill="#F0F4FC" />
          <rect x="98" y="172" width="60" height="10" rx="3" fill="#0F1E33" opacity="0.7" />
          <rect x="230" y="171" width="36" height="12" rx="4" fill="#22C55E" opacity="0.25" />
          <rect x="235" y="174" width="26" height="6" rx="3" fill="#16A34A" />
          <rect x="278" y="171" width="24" height="12" rx="4" fill="#1E5FD9" />

          <rect x="88" y="196" width="224" height="24" rx="6" fill="#FFFFFF" />
          <rect x="98" y="203" width="75" height="10" rx="3" fill="#0F1E33" opacity="0.7" />
          <rect x="230" y="202" width="36" height="12" rx="4" fill="#22C55E" opacity="0.25" />
          <rect x="235" y="205" width="26" height="6" rx="3" fill="#16A34A" />
          <rect x="278" y="202" width="24" height="12" rx="4" fill="#1E5FD9" />

          <rect x="88" y="227" width="224" height="24" rx="6" fill="#F0F4FC" />
          <rect x="98" y="234" width="50" height="10" rx="3" fill="#0F1E33" opacity="0.7" />
          <rect x="230" y="233" width="36" height="12" rx="4" fill="#E8A23A" opacity="0.25" />
          <rect x="235" y="236" width="26" height="6" rx="3" fill="#C6821E" />
          <rect x="278" y="233" width="24" height="12" rx="4" fill="#1E5FD9" />

          {/* Student & Teacher Characters Representation */}
          <circle cx="200" cy="310" r="48" fill="#FFFFFF" />
          <circle cx="200" cy="295" r="22" fill="#0F1E33" />
          <path d="M165 348 C165 315, 235 315, 235 348" fill="#1E5FD9" />
    ...
    <div className="floating-stat-badge badge-pos-top-right float-reverse">
      <div className="stat-badge-icon badge-icon-blue">
        <FileCheck size={16} color="#1E5FD9" />
      </div>
      <div className="stat-badge-content">
